...
c      subroutine lloff(p,i1,i2,zout)
c      subroutine lloff(p,pp,mm,pm,mp)
      subroutine lloff(p)
      implicit double precision(a-y)
      implicit complex*16(z)
      complex*16 pp,mm,pm,mp
      double precision q1(4),q2(4),pel(4),ppos(4)
      double precision q11(4),q22(4),q1m(4),q2m(4),pelm(4),pposm(4)
      complex*16 uelb(4),vpos(4),zoutq1(4,4),zoutp(4,4),zoutq2(4,4)
      complex*16 wpm(4),wpm_5(4),wpm_5e(4,4,4)
      integer i1,i2
