      ...
      do i=1,4
         do j=1,4
            do k=1,4
               gmatrix5_1(i,j,k)=0d0
            do i1=1,4
               gmatrix5_1(i,j,k)=gmatrix5_1(i,j,k)
     &              +g5(j,i1)*gmatrix(i,i1,k)
            enddo
         enddo
      enddo
      enddo
     ...
     &           +gmatrix(i,i1,k1)*gmatrix_2(j,k,k1,j1)
      ...
      do i1=1,4
      do j1=1,4  
         gmatrix_4(i,j,k,l,i1,j1)=0d0
         do k1=1,4
            gmatrix_4(i,j,k,l,i1,j1)=gmatrix_4(i,j,k,l,i1,j1)
     &           +gmatrix(i,i1,k1)*gmatrix_3(j,k,l,k1,j1)
         enddo
      enddo
      enddo
      enddo
      ...
      do i1=1,4
      do j1=1,4  
         gmatrix_5(i,j,k,l,m,i1,j1)=0d0
         do k1=1,4
            gmatrix_5(i,j,k,l,m,i1,j1)=gmatrix_5(i,j,k,l,m,i1,j1)
     &           +gmatrix(i,i1,k1)*gmatrix_4(j,k,l,m,k1,j1)
         enddo
      enddo
      enddo
      enddo
